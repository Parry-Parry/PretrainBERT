...
class StandardProcessor(object):
    ...
    @staticmethod
    def create_record(inp, attn, seg, nsp, pos, labels):
        return {'input_ids': inp, 'attention_mask': attn, 'segment_ids': seg, 'nsp_label': nsp, 'mlm_positions': pos, 'mlm_labels': labels}
